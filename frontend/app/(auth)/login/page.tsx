...
import { login, ApiException } from "@/app/lib/api";
        ...
        <div className="min-h-screen bg-void grid-bg flex items-center justify-center px-4">
            ...
            <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }}
                ...
                <div className="bg-surface-1 border border-border-1 rounded-2xl p-8">
                    <h1 className="font-display font-bold text-2xl text-chrome mb-1">Sign in</h1>
                    <p className="text-chrome-dim text-sm font-mono mb-8">Access the AI SRE control plane</p>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <div>
                            <label className="block text-xs font-mono text-chrome-dim mb-1.5">Password</label>
                            <div className="relative">
                    ...
                    <p className="text-center text-xs font-mono text-chrome-dim mt-6">
                        ...
                        <Link href="/register" className="text-plasma hover:underline">Register</Link>
                    </p>
                </div>
            </motion.div>
        </div>
